...
- Brand identity — `TBaguette`, `TBaguette's Atelier` — stays literal in every locale. Never put these into a translated string; keep them as Python literals joined around translated copy.
