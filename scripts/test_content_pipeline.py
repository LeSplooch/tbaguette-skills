...
real constructs found while surveying the 74-skill corpus (escaped pipes in
...
class BuildContentIntegrationTests(unittest.TestCase):
    ...
    def test_finds_exactly_74_skills(self):
        self.assertEqual(len(self.content["skills"]), 74)
    ...
    def test_category_skill_slug_counts_sum_to_74(self):
