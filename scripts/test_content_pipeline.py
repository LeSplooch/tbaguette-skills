...
real constructs found while surveying the 87-skill corpus (escaped pipes in
...
class BuildContentIntegrationTests(unittest.TestCase):
    ...
    def test_finds_exactly_87_skills(self):
        self.assertEqual(len(self.content["skills"]), 87)
    ...
    def test_category_skill_slug_counts_sum_to_87(self):
