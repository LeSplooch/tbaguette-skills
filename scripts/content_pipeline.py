...
Reads the 91 skill directories under ``~/.claude/skills/TBaguette/skills/``
...
def build_content(
    ...
    # stops linking, rather than shipping 91 pages of 404s.
...
#
# Deliberately not a list of the 91 real slugs. This matches *slug-shaped*
