...
<!-- Generated by scripts/copilot_agents.py from scripts/copilot_agents/investigator.md and delegating-tasks-with-review-gates/reference/. Edit those, not this file. -->
